...
import argparse
from test_utils import _logger, set_requires_grad
from test_load_raw import data_generator
from test_train_ts_tcc import Trainer, model_evaluate
from test_ts_tcc import TC
from test_utils import _calc_metrics, copy_Files
from test_ts_tcc import base_Model
...
def origin_model():
    ...
    parser.add_argument('--training_mode', default='supervised', type=str,
                        help='Modes of choice: random_init, supervised, self_supervised, fine_tune, train_linear')#'Modes of choice: random_init, supervised, self_supervised, fine_tune, train_linear'
    ...
    # Trainer
    train_result = Trainer(model, temporal_contr_model, model_optimizer, temporal_contr_optimizer, train_dl, valid_dl, test_dl, device, logger, configs, experiment_log_dir, training_mode)
